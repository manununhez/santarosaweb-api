         ...
         function addedValuesToList(data) {
             html = data.map((item) => {
                 if (item.type === "products") {
                     ...
                     return '<ul><li>' + item.type + '<a href="' + item.url + '"><div class="float-container">' + '<div class="float-child-left"><img src="https://santarosadelaguaray.online/uploads/' + item.searchable.image_url + '"></div><div class="float-child-right"><p>' + item.title + '</p></div></div></a></li></ul>';
                 } else if (item.type === "item_categories") {
                     console.log(item.searchable.image_url_logo);
                     return '<ul><li>' + item.type + '<a href="' + item.url + '"><div class="float-container">' + '<div class="float-child-left"><img src="https://santarosadelaguaray.online/uploads/' + item.searchable.image_url_logo + '"></div><div class="float-child-right"><p>' + item.title + '</p></div></div></a></li></ul>';
